...
from vantage6_strongaya_measures_licenced.proms.eortc_qlq_scoring import check_input_structure, ItemsToScoreInput


@algorithm_client
def central(client: AlgorithmClient, items_to_score: ItemsToScoreInput, variables_to_stratify: StratificationDetails = None,
            organisation_ids: List[int] = None) -> Dict[str, Any]:
    """
    Central function to aggregate EORTC QLQ scoring results from multiple organisations.
    ...
    safe_log("info", "Creating subtask to calculate EORTC QLQ-C30 style scores and their general statistics.")

    input_ = {"method": "partial_eortc_qlq_general_statistics",
              "kwargs": {
    ...
    task_general_statistics = client.task.create(input_, organisation_ids,
                                                 "EORTC QLQ Scoring - General Statistics",
                                                 "This subtask determines the general statistics of "
                                                 "EORTC QLQ-C30 style questionnaires' domain scores.")
    ...
    input_ = {"method": "partial_eortc_qlq_aggregate_adjusted_deviation",
              "kwargs": {
    ...
    task_adjusted_deviation = client.task.create(input_, organisation_ids,
                                                 "EORTC QLQ Scoring - Aggregate Adjusted Deviation",
